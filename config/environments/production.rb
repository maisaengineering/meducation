Meducation::Application.configure do
  ...
  # For Heroku enable static assets serve and cache
  # Ref: http://hawkins.io/2012/07/advanced_caching_part_3-static_assets/
  ...
  ENV['WEEKLY_SENDER'] = 'maisa.engineers@gmail.com'
  ...
  #  :port => 587,
  #  :domain => "mykidslink.com",
  #  :authentication => :login,
  #  :user_name => 'smtp@mykidslink.com',
  #  :password => 'kids.mail1',
  #}

  #config.action_mailer.smtp_settings = {
  #    :enable_starttls_auto => false,
  #    :address => "smtp-large.dynect.net",
  #    :port => 587,
  #    :domain => "mykidslink.com",
  #    :authentication => :login,
  #    :user_name => 'it@mykidslink.com',
  #    :password => 'super.gyr01',
  #}
